...
describe('Negotiation', () => {
    ...
    it('implements negotiation process with success and failure', () => {
        ...
        cy.get('.modal-dialog .modal-body').contains('Maximum offer was: 10');
        cy.get('.modal-dialog .modal-body').contains('Minimum expected salary was: 10');
        ...
        //test failure case
        cy.submitSalary(11, 'Employer-Tab');
        ...
        cy.submitSalary(12, 'Employee-Tab');
